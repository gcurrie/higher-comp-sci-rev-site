...
(function () {
  ...
  const INDEX = [
    ...
    { term: 'Sequence', desc: 'Instructions executed one after another in order', page: 'sdd/modular-programming.html', section: 'SDD' },
    { term: 'Selection', desc: 'Choosing which code to run based on a condition — IF/ELSE or CASE', page: 'sdd/modular-programming.html', section: 'SDD' },
    { term: 'Iteration', desc: 'Repeating a block of code using a loop', page: 'sdd/modular-programming.html', section: 'SDD' },
    { term: 'Fixed loop', desc: 'FOR loop — repeats a set number of times', page: 'sdd/modular-programming.html', section: 'SDD' },
    { term: 'Conditional loop', desc: 'WHILE or REPEAT loop — repeats while a condition is true', page: 'sdd/modular-programming.html', section: 'SDD' },
    ...
    { term: 'Pre-defined functions', desc: 'Built-in functions: substrings, chr/ASC, INT/ROUND, MOD', page: 'sdd/modular-programming.html', section: 'SDD' },
    { term: 'Substring', desc: 'Pre-defined function to extract part of a string — SUBSTRING(str, start, length)', page: 'sdd/modular-programming.html', section: 'SDD' },
    { term: 'CHR', desc: 'Pre-defined function that converts an ASCII code number to a character', page: 'sdd/modular-programming.html', section: 'SDD' },
    { term: 'ASC', desc: 'Pre-defined function that returns the ASCII code of a character', page: 'sdd/modular-programming.html', section: 'SDD' },
    { term: 'MOD', desc: 'Modulus operator — returns the remainder after integer division', page: 'sdd/modular-programming.html', section: 'SDD' },
    { term: 'Modulus', desc: 'The remainder after dividing one integer by another — used with MOD operator', page: 'sdd/modular-programming.html', section: 'SDD' },
