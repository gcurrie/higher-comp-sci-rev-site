...
(function () {
  ...
  const INDEX = [
    ...
    { term: 'Sequence', desc: 'Instructions executed one after another in order', page: 'sdd/computational-constructs.html', section: 'SDD' },
    { term: 'Selection', desc: 'Choosing which code to run based on a condition — IF/ELSE or CASE', page: 'sdd/computational-constructs.html', section: 'SDD' },
    { term: 'Iteration', desc: 'Repeating a block of code using a loop', page: 'sdd/computational-constructs.html', section: 'SDD' },
    { term: 'Fixed loop', desc: 'FOR loop — repeats a set number of times', page: 'sdd/computational-constructs.html', section: 'SDD' },
    { term: 'Conditional loop', desc: 'WHILE or REPEAT loop — repeats while a condition is true', page: 'sdd/computational-constructs.html', section: 'SDD' },
    { term: 'Subprogram', desc: 'Named block of reusable code — a procedure or function', page: 'sdd/computational-constructs.html', section: 'SDD' },
    { term: 'Procedure', desc: 'Subprogram that performs an action but does not return a value', page: 'sdd/computational-constructs.html', section: 'SDD' },
    { term: 'Function', desc: 'Subprogram that performs a calculation and returns a value via RETURN', page: 'sdd/computational-constructs.html', section: 'SDD' },
    { term: 'Formal parameter', desc: 'Named placeholder in a subprogram definition that receives the passed value', page: 'sdd/computational-constructs.html', section: 'SDD' },
    { term: 'Actual parameter', desc: 'The real value or variable passed in when calling a subprogram', page: 'sdd/computational-constructs.html', section: 'SDD' },
    { term: 'Parameter passing', desc: 'Passing data into a subprogram using formal and actual parameters', page: 'sdd/computational-constructs.html', section: 'SDD' },
    { term: 'Local variable', desc: 'Variable declared inside a subprogram — only accessible within it', page: 'sdd/computational-constructs.html', section: 'SDD' },
    { term: 'Global variable', desc: 'Variable declared outside subprograms — accessible throughout the program', page: 'sdd/computational-constructs.html', section: 'SDD' },
    { term: 'Scope', desc: 'Where in a program a variable can be accessed — local or global', page: 'sdd/computational-constructs.html', section: 'SDD' },
    { term: 'Pre-defined functions', desc: 'Built-in functions: substrings, chr/ASC, INT/ROUND, MOD', page: 'sdd/computational-constructs.html', section: 'SDD' },
    { term: 'Substring', desc: 'Pre-defined function to extract part of a string — SUBSTRING(str, start, length)', page: 'sdd/computational-constructs.html', section: 'SDD' },
    { term: 'CHR', desc: 'Pre-defined function that converts an ASCII code number to a character', page: 'sdd/computational-constructs.html', section: 'SDD' },
    { term: 'ASC', desc: 'Pre-defined function that returns the ASCII code of a character', page: 'sdd/computational-constructs.html', section: 'SDD' },
    { term: 'MOD', desc: 'Modulus operator — returns the remainder after integer division', page: 'sdd/computational-constructs.html', section: 'SDD' },
    { term: 'Modulus', desc: 'The remainder after dividing one integer by another — used with MOD operator', page: 'sdd/computational-constructs.html', section: 'SDD' },
    { term: 'File handling', desc: 'Reading from and writing to text or CSV files using OPEN, RECEIVE, SEND, CLOSE', page: 'sdd/computational-constructs.html', section: 'SDD' },
    { term: 'Sequential file access', desc: 'Reading a file from start to finish in order — the Higher file access method', page: 'sdd/computational-constructs.html', section: 'SDD' },
    { term: 'EOF', desc: 'End of File marker — used in WHILE NOT EOF loops when reading files', page: 'sdd/computational-constructs.html', section: 'SDD' },
    { term: 'CSV', desc: 'Comma-Separated Values — a plain text file format storing tabular data', page: 'sdd/computational-constructs.html', section: 'SDD' },
